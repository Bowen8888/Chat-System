...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	{
		public const byte RPC_TRANSMIT_MESSSGE = 0 + 5;
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject.RegisterRpc("TransmitMesssge", TransmitMesssge, typeof(string), typeof(string));
		...
		/// string message
		/// </summary>
		public abstract void TransmitMesssge(RpcArgs args);
